      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {/* User Account */}
            <button className="p-2 text-purple-200 hover:text-white hover:bg-purple-800/30 rounded-lg transition-colors duration-200">
              <User className="h-5 w-5" />
            </button>

            {/* CTA Button */}
            <Link href="/sell" className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white px-6 py-2 rounded-lg font-medium transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-purple-500/25">
              Sell Phone
            </Link>
          </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-slate-900/95 backdrop-blur-lg border-t border-purple-800/30">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            {/* Mobile Actions */}
            <div className="border-t border-purple-800/30 pt-4 flex items-center justify-between px-3">
