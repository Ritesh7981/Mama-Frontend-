...
import { Smartphone, Star, Tag, Zap, Camera, Gamepad2, Briefcase, Video, Search, Filter, ChevronDown, TrendingUp, Shield, Battery, Cpu, Edit } from 'lucide-react';
...
const PhoneUI = () => {
  ...
  const handleEdit = (data) => {
    ...
    router.push(`/editPhone/${data._id}?${queryParams}`);
  };
              ...
              >
                ...
                <div className="relative p-8">
                  ...
                  <div className='flex items-center gap-2'>
                    ...
                    <button onClick={() => handleEdit(phone)} className=' bg-gray-600 cursor-pointer text-white font-semibold p-2 flex items-center py-4 px-6 rounded-2xl'>
                     Edit <Edit/>
                    </button>
                  </div>
                </div>
